...
class PredictionPipeline:
    ...
    def predict(self,features):
        ...
        # created function for load object in utils.py and called them
...
# create custom class based on out dataset
class CustomClass:
    def __init__(self,
                 age: int,
                 workclass: int, 
    ...
    # create the function to convert data into dataframe with the help of dictionary
